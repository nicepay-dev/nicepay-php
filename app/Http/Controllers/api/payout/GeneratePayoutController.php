...
class GeneratePayoutController extends Controller
{
    ...
    protected $generate_payout_endpoint = "/api/v1.0/transfer/registration";
     ...
     * @return JsonResponse
     */
    public function generatePayout(): JsonResponse
    {
        $url = HttpUtil::getNicepayDomain($this->useProd, $this->useCloud) . $this->generate_payout_endpoint;
