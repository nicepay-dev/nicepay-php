...
class ApprovePayoutController extends Controller
{
    ...
    protected $approve_payout_endpoint = "/api/v1.0/transfer/approve";
     ...
     * @return JsonResponse
     */
    public function approvePayout(): JsonResponse
    {
        $url = HttpUtil::getNicepayDomain($this->useProd, $this->useCloud) . $this->approve_payout_endpoint;
