...
class RefundQrisController extends Controller{
    ...
    // Refund QRIS Endpoint
    protected $useProd = false;
    protected $useCloud = false;
    protected $refund_qris_endpoint = "/api/v1.0/qr/qr-mpm-refund";
    ...
    {
        $url = HttpUtil::getNicepayDomain($this->useProd, $this->useCloud) . $this->refund_qris_endpoint;
        $helper = new Helpers();
