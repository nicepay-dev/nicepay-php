...
class RedirectV2Controller extends Controller
{
    // VA Endpoint
    protected $useProd = false;
    protected $useCloud = false;
    protected $registration_endpoint = "/nicepay/redirect/v2/registration";
    ...
    {   $url = HttpUtil::getNicepayDomain($this->useProd, $this->useCloud) . $this->cancel_endpoint;
        ...
        //request body parameter
        $timestamp = Carbon::now()->format("YmdHis");
        $txid = "NORMALTEST00202507011622205427";
        $amt = $this->amt;
